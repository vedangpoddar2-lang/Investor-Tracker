...
export default function InvestorDrawer({ investorId, onClose, onUpdate, onDelete, initialTab = 'details' }) {
        ...
        <>
            ...
            >
                ...
                <div className="drawer-tabs">
                    ...
                    <button className={activeTab === 'todos' ? 'active' : ''} onClick={() => setActiveTab('todos')}>To-Dos</button>
                    ...
                    {activeTab === 'todos' && (
                        <div className="drawer-section">
                            ...
                            <form className="drawer-add-form" onSubmit={handleAddTodo}>
                                ...
                                <input className="input" value={newTodoOwner}
                                    onChange={(e) => setNewTodoOwner(e.target.value)}
                                    placeholder="Owner..." style={{ width: 100 }} />
